...
export default class commentBox extends Component {
  ...
  async componentWillMount() {
    ...
    const port = window.disqusProxy.port
      ? `:${window.disqusProxy.port.toString()}`
      : '';
    const url = '//' + window.disqusProxy.server + port + '/api/getThreads';
  ...
  async postComment() {
    ...
    const port = window.disqusProxy.port
      ? `:${window.disqusProxy.port.toString()}`
      : '';
    const url = '//' + window.disqusProxy.server + port + '/api/createComment';
        ...
        >
          ...
          <textarea
            ...
            style={{
              ...
              outline: 'none',
              border: this.state.messageValid
                ? 'none'
        ...
        >
          <label style={styles.label}>
            <span style={styles.span}>
              <i className="fa fa-user-o" aria-hidden="true" /> 昵称（公开）{' '}
            </span>
            <input
              type="text"
              style={{
                ...styles.input,
                border: this.state.authorNameValid
                  ? '1px solid #ccc'
                  : ' 1px solid #ff7500',
                marginLeft: 13
              }}
          ...
          <label style={styles.label}>
            ...
            <input
              ...
              style={{
                ...styles.input,
                border: this.state.authorEmailValid
                  ? '1px solid #ccc'
                  : ' 1px solid #ff7500'
              }}
